#!/bin/bash
#SBATCH --job-name=lingbot_quant_ff
...
#SBATCH --output=/home/%u/DLES/results/logs/%j_quant_ff.out
#SBATCH --error=/home/%u/DLES/results/logs/%j_quant_ff.err
...
python -m evaluation.robotwin.eval_polict_client_openpi \
    ...
    --ckpt_setting quant_ff \
    --seed 0 \
    --policy_name LingBotVA \
    --save_root ~/DLES/results/quant_ff \
    --port 29056 \
    --test_num 16 \
